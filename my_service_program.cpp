...
void svcCallback(const ev3_services::Gostraight::Request &req , ev3_services::Gostraight::Response &res){ // The callback function
...
ros::ServiceServer<ev3_services::Gostraight::Request, ev3_services::Gostraight::Response> server("Gostraight",&svcCallback); //SERVICE DEFINITION servvice name is Gostraight
